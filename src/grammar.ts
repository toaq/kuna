...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "CPna_main", "symbols": ["Clause_main"], "postprocess": makeBranchCovertLeft('CP', 'C', 'REL')},
    {"name": "CPna_sub", "symbols": ["Clause_sub"], "postprocess": makeBranchCovertLeft('CP', 'C', 'REL')},
    ...
    {"name": "nP", "symbols": [], "postprocess": makeEmptynP},

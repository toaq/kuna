...
const grammar: Grammar = {
  Lexer: lexer,
  ParserRules: [
    {"name": "Fragment", "symbols": ["Free"], "postprocess": id},
    {"name": "Fragment", "symbols": ["Free", "Fragment"], "postprocess": makeFreeFragment},
    ...
    {"name": "DP", "symbols": ["Pronoun", "DP$ebnf$1"], "postprocess": makeFree(id)},
    {"name": "DP", "symbols": ["WordD", "Word"], "postprocess": makeBranch('DP')},
    {"name": "DP", "symbols": ["D", "CPdetopt"], "postprocess": makeBranch('DP')},
    {"name": "DP", "symbols": ["Dtonal", "CPdet"], "postprocess": makeBranch('DP')},
    {"name": "DPincorp$ebnf$1", "symbols": []},
    {"name": "DPincorp$ebnf$1", "symbols": ["DPincorp$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "DPincorp", "symbols": [(lexer.has("incorporated_pronoun") ? {type: "incorporated_pronoun"} : incorporated_pronoun), "DPincorp$ebnf$1"], "postprocess": makeFree(makeLeaf('DP'))},
    {"name": "DPincorp", "symbols": ["WordDincorp", "Word"], "postprocess": makeBranch('DP')},
    {"name": "DPincorp", "symbols": ["Dincorp", "CPdetopt"], "postprocess": makeBranch('DP')},
    {"name": "DPincorp", "symbols": ["Dtonalincorp", "CPdet"], "postprocess": makeBranch('DP')},
    {"name": "DPsub", "symbols": ["D", "CPsub"], "postprocess": makeBranch('DP')},
    {"name": "DPsub", "symbols": ["Dtonal", "CPsub"], "postprocess": makeBranch('DP')},
    {"name": "DPsubincorp", "symbols": ["Dincorp", "CPsub"], "postprocess": makeBranch('DP')},
    {"name": "DPsubincorp", "symbols": ["Dtonalincorp", "CPsub"], "postprocess": makeBranch('DP')},
    {"name": "CPdetopt", "symbols": [], "postprocess": makeEmptyCP},
    {"name": "CPdetopt", "symbols": ["CPdet"], "postprocess": id},
    ...
    {"name": "Adjunct", "symbols": [(lexer.has("preposition") ? {type: "preposition"} : preposition), "Adjunct$ebnf$1"], "postprocess": makeFree(makeLeaf('Adjunct'))},
    {"name": "Conjunction$ebnf$1", "symbols": []},
    {"name": "Conjunction$ebnf$1", "symbols": ["Conjunction$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Conjunction", "symbols": [(lexer.has("conjunction") ? {type: "conjunction"} : conjunction), "Conjunction$ebnf$1"], "postprocess": makeFree(makeLeaf('&'))},
    ...
    {"name": "ConjunctionT1", "symbols": [(lexer.has("conjunction_in_t1") ? {type: "conjunction_in_t1"} : conjunction_in_t1), "ConjunctionT1$ebnf$1"], "postprocess": makeFree(makeLeaf('&'))},
    ...
    {"name": "ConjunctionT4", "symbols": [(lexer.has("conjunction_in_t4") ? {type: "conjunction_in_t4"} : conjunction_in_t4), "ConjunctionT4$ebnf$1"], "postprocess": makeFree(makeLeaf('&'))},
    ...
    {"name": "Asp", "symbols": [(lexer.has("aspect") ? {type: "aspect"} : aspect), "Asp$ebnf$1"], "postprocess": makeFree(makeLeaf('Asp'))},
    {"name": "Asp_prefix$ebnf$1", "symbols": []},
    {"name": "Asp_prefix$ebnf$1", "symbols": ["Asp_prefix$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Asp_prefix", "symbols": [(lexer.has("prefix_aspect") ? {type: "prefix_aspect"} : prefix_aspect), "Asp_prefix$ebnf$1"], "postprocess": makeFree(makeLeaf('Asp'))},
    {"name": "Bi$ebnf$1", "symbols": []},
    {"name": "Bi$ebnf$1", "symbols": ["Bi$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Bi", "symbols": [(lexer.has("topic_marker") ? {type: "topic_marker"} : topic_marker), "Bi$ebnf$1"], "postprocess": makeFree(makeLeaf('Topic'))},
    {"name": "C$ebnf$1", "symbols": []},
    {"name": "C$ebnf$1", "symbols": ["C$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "C", "symbols": [(lexer.has("complementizer") ? {type: "complementizer"} : complementizer), "C$ebnf$1"], "postprocess": makeFree(makeLeaf('C'))},
    ...
    {"name": "Csub", "symbols": [(lexer.has("subordinating_complementizer") ? {type: "subordinating_complementizer"} : subordinating_complementizer), "Csub$ebnf$1"], "postprocess": makeFree(makeLeaf('C'))},
    {"name": "D$ebnf$1", "symbols": []},
    {"name": "D$ebnf$1", "symbols": ["D$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "D", "symbols": [(lexer.has("determiner") ? {type: "determiner"} : determiner), "D$ebnf$1"], "postprocess": makeFree(makeLeaf('D'))},
    {"name": "Dincorp$ebnf$1", "symbols": []},
    {"name": "Dincorp$ebnf$1", "symbols": ["Dincorp$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Dincorp", "symbols": [(lexer.has("incorporated_determiner") ? {type: "incorporated_determiner"} : incorporated_determiner), "Dincorp$ebnf$1"], "postprocess": makeFree(makeLeaf('D'))},
    {"name": "Dtonal$ebnf$1", "symbols": []},
    {"name": "Dtonal$ebnf$1", "symbols": ["Dtonal$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Dtonal", "symbols": [(lexer.has("tonal_determiner") ? {type: "tonal_determiner"} : tonal_determiner), "Dtonal$ebnf$1"], "postprocess": makeFree(makeLeaf('D'))},
    {"name": "Dtonalincorp$ebnf$1", "symbols": []},
    {"name": "Dtonalincorp$ebnf$1", "symbols": ["Dtonalincorp$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Dtonalincorp", "symbols": [(lexer.has("tonal_incorporated_determiner") ? {type: "tonal_incorporated_determiner"} : tonal_incorporated_determiner), "Dtonalincorp$ebnf$1"], "postprocess": makeFree(makeLeaf('D'))},
    ...
    {"name": "EvA", "symbols": [(lexer.has("event_accessor") ? {type: "event_accessor"} : event_accessor), "EvA$ebnf$1"], "postprocess": makeFree(makeLeaf('EvA'))},
    {"name": "Focus$ebnf$1", "symbols": []},
    {"name": "Focus$ebnf$1", "symbols": ["Focus$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Focus", "symbols": [(lexer.has("focus_particle") ? {type: "focus_particle"} : focus_particle), "Focus$ebnf$1"], "postprocess": makeFree(makeLeaf('Focus'))},
    {"name": "Go$ebnf$1", "symbols": []},
    {"name": "Go$ebnf$1", "symbols": ["Go$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Go", "symbols": [(lexer.has("retroactive_cleft") ? {type: "retroactive_cleft"} : retroactive_cleft), "Go$ebnf$1"], "postprocess": makeFree(makeLeaf('𝘷'))},
    {"name": "WordD$ebnf$1", "symbols": []},
    {"name": "WordD$ebnf$1", "symbols": ["WordD$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "WordD", "symbols": [(lexer.has("word_determiner") ? {type: "word_determiner"} : word_determiner), "WordD$ebnf$1"], "postprocess": makeFree(makeLeaf('D'))},
    {"name": "WordDincorp$ebnf$1", "symbols": []},
    {"name": "WordDincorp$ebnf$1", "symbols": ["WordDincorp$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "WordDincorp", "symbols": [(lexer.has("incorporated_word_determiner") ? {type: "incorporated_word_determiner"} : incorporated_word_determiner), "WordDincorp$ebnf$1"], "postprocess": makeFree(makeLeaf('D'))},
    {"name": "Interjection", "symbols": [(lexer.has("interjection") ? {type: "interjection"} : interjection)], "postprocess": makeLeaf('SAP')},
    {"name": "Ki$ebnf$1", "symbols": []},
    {"name": "Ki$ebnf$1", "symbols": ["Ki$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Ki", "symbols": [(lexer.has("adjective_marker") ? {type: "adjective_marker"} : adjective_marker), "Ki$ebnf$1"], "postprocess": makeFree(makeLeaf('Adjunct'))},
    {"name": "Mi$ebnf$1", "symbols": []},
    {"name": "Mi$ebnf$1", "symbols": ["Mi$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Mi", "symbols": [(lexer.has("name_verb") ? {type: "name_verb"} : name_verb), "Mi$ebnf$1"], "postprocess": makeFree(makeLeaf('mı'))},
    {"name": "Mo$ebnf$1", "symbols": []},
    {"name": "Mo$ebnf$1", "symbols": ["Mo$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Mo", "symbols": [(lexer.has("text_quote") ? {type: "text_quote"} : text_quote), "Mo$ebnf$1"], "postprocess": makeFree(makeLeaf('mo'))},
    {"name": "Q$ebnf$1", "symbols": []},
    {"name": "Q$ebnf$1", "symbols": ["Q$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Q", "symbols": [(lexer.has("quantifier") ? {type: "quantifier"} : quantifier), "Q$ebnf$1"], "postprocess": makeFree(makeLeaf('Q'))},
    {"name": "QT4$ebnf$1", "symbols": []},
    {"name": "QT4$ebnf$1", "symbols": ["QT4$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "QT4", "symbols": [(lexer.has("quantifier_with_complement") ? {type: "quantifier_with_complement"} : quantifier_with_complement), "QT4$ebnf$1"], "postprocess": makeFree(makeLeaf('Q'))},
    {"name": "Na$ebnf$1", "symbols": []},
    {"name": "Na$ebnf$1", "symbols": ["Na$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Na", "symbols": [(lexer.has("cleft_verb") ? {type: "cleft_verb"} : cleft_verb), "Na$ebnf$1"], "postprocess": makeFree(makeLeaf('𝘷'))},
    ...
    {"name": "Roi", "symbols": [(lexer.has("plural_coordinator") ? {type: "plural_coordinator"} : plural_coordinator), "Roi$ebnf$1"], "postprocess": makeFree(makeLeaf('&'))},
    {"name": "SA$ebnf$1", "symbols": []},
    {"name": "SA$ebnf$1", "symbols": ["SA$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "SA", "symbols": [(lexer.has("illocution") ? {type: "illocution"} : illocution), "SA$ebnf$1"], "postprocess": makeFree(makeLeaf('SA'))},
    ...
    {"name": "Sigma", "symbols": [(lexer.has("polarity") ? {type: "polarity"} : polarity), "Sigma$ebnf$1"], "postprocess": makeFree(makeLeaf('Σ'))},
    {"name": "Shu$ebnf$1", "symbols": []},
    {"name": "Shu$ebnf$1", "symbols": ["Shu$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Shu", "symbols": [(lexer.has("word_quote") ? {type: "word_quote"} : word_quote), "Shu$ebnf$1"], "postprocess": makeFree(makeLeaf('shu'))},
    {"name": "T$ebnf$1", "symbols": []},
    {"name": "T$ebnf$1", "symbols": ["T$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "T", "symbols": [(lexer.has("tense") ? {type: "tense"} : tense), "T$ebnf$1"], "postprocess": makeFree(makeLeaf('T'))},
    {"name": "T_prefix$ebnf$1", "symbols": []},
    {"name": "T_prefix$ebnf$1", "symbols": ["T_prefix$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "T_prefix", "symbols": [(lexer.has("prefix_tense") ? {type: "prefix_tense"} : prefix_tense), "T_prefix$ebnf$1"], "postprocess": makeFree(makeLeaf('T'))},
    {"name": "Text$ebnf$1", "symbols": []},
    {"name": "Text$ebnf$1", "symbols": ["Text$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Text", "symbols": [(lexer.has("text") ? {type: "text"} : text), "Text$ebnf$1"], "postprocess": makeFree(makeLeaf('text'))},
    {"name": "Teo$ebnf$1", "symbols": []},
    {"name": "Teo$ebnf$1", "symbols": ["Teo$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Teo", "symbols": [(lexer.has("end_quote") ? {type: "end_quote"} : end_quote), "Teo$ebnf$1"], "postprocess": makeFree(makeLeaf('teo'))},
    {"name": "V$ebnf$1", "symbols": []},
    {"name": "V$ebnf$1", "symbols": ["V$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "V", "symbols": [(lexer.has("predicate") ? {type: "predicate"} : predicate), "V$ebnf$1"], "postprocess": makeFree(makeLeaf('V'))},
    {"name": "Voiv$ebnf$1", "symbols": []},
    {"name": "Voiv$ebnf$1", "symbols": ["Voiv$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Voiv", "symbols": [(lexer.has("predicatizer") ? {type: "predicatizer"} : predicatizer), "Voiv$ebnf$1"], "postprocess": makeFree(makeLeaf('V'))},
    {"name": "Word$ebnf$1", "symbols": []},
    {"name": "Word$ebnf$1", "symbols": ["Word$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Word", "symbols": [(lexer.has("word") ? {type: "word"} : word), "Word$ebnf$1"], "postprocess": makeFree(makeLeaf('word'))},

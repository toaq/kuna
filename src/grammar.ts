...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "CPdet", "symbols": ["QSPdet"], "postprocess": makeBranchCovertLeft('CPrel', 'Crel')},
    ...
    {"name": "Serialdet$ebnf$1", "symbols": ["Serialdet$ebnf$1", "V1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Serialdet", "symbols": ["Serialdet$ebnf$1", "Vlast"], "postprocess": makeSerial('*Serialdet')},
    {"name": "Serialdet", "symbols": [], "postprocess": makeEmptySerialdet},

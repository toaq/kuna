...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "vP$ebnf$2$subexpression$1$ebnf$1", "symbols": ["Argument"]},
    {"name": "vP$ebnf$2$subexpression$1$ebnf$1", "symbols": ["vP$ebnf$2$subexpression$1$ebnf$1", "Argument"], "postprocess": (d) => d[0].concat([d[1]])},

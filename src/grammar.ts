...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "nP", "symbols": ["nP", "CPrel1"], "postprocess": makeBranch('𝘯P')},
    ...
    {"name": "Argument", "symbols": ["CParg1"], "postprocess": id},
    {"name": "DP1", "symbols": ["DP2"], "postprocess": id},
    {"name": "DP1", "symbols": ["DP2", "Conjunction", "DP1"], "postprocess": makeConn},
    {"name": "DP1", "symbols": ["DP2", "ConjunctionT1", "CParg1"], "postprocess": makeConn},
    ...
    {"name": "CParg1", "symbols": ["CParg2"], "postprocess": id},
    {"name": "CParg1", "symbols": ["Focus", "CParg1"], "postprocess": makeBranch('FocusP')},
    {"name": "CParg2", "symbols": ["CParg3"], "postprocess": id},
    {"name": "CParg2", "symbols": ["CParg3", "Conjunction", "CParg2"], "postprocess": makeConn},
    {"name": "CParg3", "symbols": ["CPsub"], "postprocess": makeBranchCovertLeft('DP', 'D')},
    {"name": "CPrel1", "symbols": ["CPrel"], "postprocess": id},
    {"name": "CPrel1", "symbols": ["CPrel", "Conjunction", "CPrel1"], "postprocess": makeConn},

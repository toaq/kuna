...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "TP", "symbols": ["EvA", "vP", "DP3"], "postprocess": makeEvAP},
    ...
    {"name": "vPinner$ebnf$2$subexpression$1$ebnf$1", "symbols": ["Argument"]},
    {"name": "vPinner$ebnf$2$subexpression$1$ebnf$1", "symbols": ["vPinner$ebnf$2$subexpression$1$ebnf$1", "Argument"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "VPoiv", "symbols": ["Voiv", "DP3"], "postprocess": makeBranch('VP')},
    {"name": "Argument", "symbols": ["DP3"], "postprocess": id},
    {"name": "Argument", "symbols": ["CPsub2"], "postprocess": id},
    {"name": "DP1", "symbols": ["DP"], "postprocess": id},
    {"name": "DP1", "symbols": ["DP", "Roi", "DP1"], "postprocess": makeConn},
    {"name": "DP2", "symbols": ["DP1"], "postprocess": id},
    {"name": "DP2", "symbols": ["Focus", "DP1"], "postprocess": makeBranch('FocusP')},
    {"name": "DP3", "symbols": ["DP2"], "postprocess": id},
    {"name": "DP3", "symbols": ["DP2", "Conjunction", "DP3"], "postprocess": makeConn},
    {"name": "DP3", "symbols": ["DP2", "ConjunctionT1", "CPsub2"], "postprocess": makeConn},
    {"name": "CPsub1", "symbols": ["CPsub"], "postprocess": id},
    {"name": "CPsub1", "symbols": ["CPsub", "Conjunction", "CPsub1"], "postprocess": makeConn},
    {"name": "CPsub2", "symbols": ["CPsub1"], "postprocess": id},
    {"name": "CPsub2", "symbols": ["Focus", "CPsub2"], "postprocess": makeBranch('FocusP')},

...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Clause_main", "symbols": ["ModalT4", "Csub", "Clause_sub", "Na", "CPna_main"], "postprocess": makeQP},
    {"name": "Clause_sub", "symbols": ["ModalT4", "Csub", "Clause_sub", "Na", "CPna_sub"], "postprocess": makeQP},
    ...
    {"name": "MSP_main", "symbols": ["Modal", "SigmaPcon_main"], "postprocess": makeT1QP},
    {"name": "MSP_sub", "symbols": ["Modal", "SigmaPcon_sub"], "postprocess": makeT1QP},
    {"name": "MSP_main", "symbols": ["Sigma", "Modal", "SigmaPcon_main"], "postprocess": makeSigmaT1QP},
    {"name": "MSP_sub", "symbols": ["Sigma", "Modal", "SigmaPcon_sub"], "postprocess": makeSigmaT1QP},
    {"name": "MSPdet", "symbols": ["SigmaPdet"], "postprocess": id},
    {"name": "MSPdet", "symbols": ["Modal", "SigmaPdet"], "postprocess": makeT1QP},
    {"name": "MSPdet", "symbols": ["Sigma", "Modal", "SigmaPdet"], "postprocess": makeSigmaT1QP},
    ...
    {"name": "Modal", "symbols": [(lexer.has("modality") ? {type: "modality"} : modality), "Modal$ebnf$1"], "postprocess": makeLeaf('Q')},
    {"name": "ModalT4$ebnf$1", "symbols": []},
    {"name": "ModalT4$ebnf$1", "symbols": ["ModalT4$ebnf$1", "Free"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "ModalT4", "symbols": [(lexer.has("modality_with_complement") ? {type: "modality_with_complement"} : modality_with_complement), "ModalT4$ebnf$1"], "postprocess": makeLeaf('Q')},

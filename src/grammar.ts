...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "CPdet$ebnf$1", "symbols": ["CPrelcon"], "postprocess": id},
    {"name": "CPdet$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "CPdet", "symbols": ["MSPdet", "CPdet$ebnf$1"], "postprocess": makeCPdet},
    ...
    {"name": "DPincorp", "symbols": ["Dincorp", "CPdet"], "postprocess": makeBranch('DP')},

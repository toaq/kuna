...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Clause_main", "symbols": ["ModalP", "Na", "CPna_main"], "postprocess": make3L('𝘷P', "𝘷'")},
    {"name": "Clause_sub", "symbols": ["ModalP", "Na", "CPna_sub"], "postprocess": make3L('𝘷P', "𝘷'")},
    ...
    {"name": "vP_main", "symbols": ["Serial_verb", "vP_main$ebnf$1", "vP_main$ebnf$2", "vP_main$ebnf$3"], "postprocess": makevP_main},
    ...
    {"name": "vP_sub", "symbols": ["Serial_verb", "vP_sub$ebnf$1", "vP_sub$ebnf$2", "vP_sub$ebnf$3"], "postprocess": makevP_sub},
    {"name": "vP_main$ebnf$4", "symbols": []},
    {"name": "vP_main$ebnf$4", "symbols": ["vP_main$ebnf$4", "AdjunctPcon"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "vP_main$ebnf$5$subexpression$1$ebnf$1", "symbols": ["VocArgument"]},
    {"name": "vP_main$ebnf$5$subexpression$1$ebnf$1", "symbols": ["vP_main$ebnf$5$subexpression$1$ebnf$1", "VocArgument"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "vP_main$ebnf$5$subexpression$1$ebnf$2", "symbols": []},
    {"name": "vP_main$ebnf$5$subexpression$1$ebnf$2", "symbols": ["vP_main$ebnf$5$subexpression$1$ebnf$2", "AdjunctPcon"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "vP_main$ebnf$5$subexpression$1", "symbols": ["vP_main$ebnf$5$subexpression$1$ebnf$1", "vP_main$ebnf$5$subexpression$1$ebnf$2"]},
    {"name": "vP_main$ebnf$5", "symbols": ["vP_main$ebnf$5$subexpression$1"], "postprocess": id},
    {"name": "vP_main$ebnf$5", "symbols": [], "postprocess": () => null},
    {"name": "vP_main", "symbols": ["Serial_oiv", "Argument", "vP_main$ebnf$4", "vP_main$ebnf$5"], "postprocess": makevP_main},
    {"name": "vP_sub$ebnf$4", "symbols": []},
    {"name": "vP_sub$ebnf$4", "symbols": ["vP_sub$ebnf$4", "AdjunctPcon"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "vP_sub$ebnf$5$subexpression$1$ebnf$1", "symbols": ["VocArgument"]},
    {"name": "vP_sub$ebnf$5$subexpression$1$ebnf$1", "symbols": ["vP_sub$ebnf$5$subexpression$1$ebnf$1", "VocArgument"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "vP_sub$ebnf$5$subexpression$1$ebnf$2", "symbols": []},
    {"name": "vP_sub$ebnf$5$subexpression$1$ebnf$2", "symbols": ["vP_sub$ebnf$5$subexpression$1$ebnf$2", "AdjunctPcon"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "vP_sub$ebnf$5$subexpression$1", "symbols": ["vP_sub$ebnf$5$subexpression$1$ebnf$1", "vP_sub$ebnf$5$subexpression$1$ebnf$2"]},
    {"name": "vP_sub$ebnf$5", "symbols": ["vP_sub$ebnf$5$subexpression$1"], "postprocess": id},
    {"name": "vP_sub$ebnf$5", "symbols": [], "postprocess": () => null},
    {"name": "vP_sub", "symbols": ["Serial_oiv", "Argument", "vP_sub$ebnf$4", "vP_sub$ebnf$5"], "postprocess": makevP_sub},
    {"name": "vPdet$ebnf$1", "symbols": ["Argincorp"], "postprocess": id},
    {"name": "vPdet$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "vPdet", "symbols": ["Serialdet_verb", "vPdet$ebnf$1"], "postprocess": makevPdet},
    {"name": "vPdet", "symbols": ["Serialdet_oiv", "Argument"], "postprocess": makevPdet},
    {"name": "AdjunctP", "symbols": ["Adjunct", "Serial_verb", "Argument"], "postprocess": makeAdjunctPT},
    {"name": "AdjunctP", "symbols": ["Adjunct", "Serial_oiv", "Argument"], "postprocess": makeAdjunctPT},
    {"name": "AdjunctP", "symbols": ["Adjunct", "Serial_verb"], "postprocess": makeAdjunctPI},
    {"name": "Serial_verb$ebnf$1", "symbols": []},
    {"name": "Serial_verb$ebnf$1", "symbols": ["Serial_verb$ebnf$1", "V1orKi"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Serial_verb", "symbols": ["Serial_verb$ebnf$1", "Vlast_verb"], "postprocess": makeSerial},
    {"name": "Serial_oiv$ebnf$1", "symbols": []},
    {"name": "Serial_oiv$ebnf$1", "symbols": ["Serial_oiv$ebnf$1", "V1orKi"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Serial_oiv", "symbols": ["Serial_oiv$ebnf$1", "Vlast_oiv"], "postprocess": makeSerial},
    {"name": "V1orKi", "symbols": ["V1"], "postprocess": id},
    {"name": "V1orKi", "symbols": ["Ki"], "postprocess": id},
    {"name": "Serialdet_verb", "symbols": ["Serial_verb"], "postprocess": id},
    {"name": "Serialdet_oiv", "symbols": ["Serial_oiv"], "postprocess": id},
    {"name": "Serialdet_verb", "symbols": [], "postprocess": makeEmptySerial()},
    ...
    {"name": "Vlast_verb", "symbols": ["Verb", "ConjunctionT1", "Vlast_verb"], "postprocess": makeConn},
    {"name": "Vlast_oiv", "symbols": ["Verb", "ConjunctionT1", "Vlast_oiv"], "postprocess": makeConn},
    {"name": "Vlast_oiv", "symbols": ["Voiv"], "postprocess": id},
    {"name": "Vlast_verb", "symbols": ["Verb"], "postprocess": id},

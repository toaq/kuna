...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "VPincorp", "symbols": ["V", "DPincorp"], "postprocess": makeIncorp},
    {"name": "VPincorp", "symbols": ["V", "CPincorp"], "postprocess": makeIncorp},
    {"name": "VPincorp", "symbols": ["Voiv", "DPcon"], "postprocess": makeIncorp},
